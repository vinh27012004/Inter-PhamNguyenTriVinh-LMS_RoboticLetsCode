...
export default function SubcourseDetailPage() {
  ...
  const handleLessonClick = (lessonSlug: string) => {
    router.push(
      `/programs/${programSlug}/subcourses/${subcourseSlug}/lessons/${lessonSlug}`
    );
  };
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-700 leading-relaxed text-justify">
                      {subcourse.description || "Chưa cập nhật"}
                    </p>
                  </div>
                  ...
                  <div className="bg-brandPurple-50 rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-brandPurple-600">
                        {subcourse.lesson_count}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <ArrowLeft
                            className={`w-6 h-6 text-brandPurple-600 transform transition-transform duration-300 ${
                              expandedLesson === lesson.id
                                ? "rotate-90"
                                : "rotate-180"
                            }`}
